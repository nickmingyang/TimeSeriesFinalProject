...
points(266:269,c(df$AVG_EP[266:266],pred.short$f),type='o',lty=1,cex=.6,lwd=1,pch=1,col=2)
points(266:269,c(df$AVG_EP[266:266],pred.short$ul),type='l',lty=3,cex=0.6,lwd=2,pch=1,col='blue3')
points(266:269,c(df$AVG_EP[266:266],pred.short$ll),type='l',lty=3,cex=0.6,lwd=2,pch=1,col='blue3')
...
f_ricco = fore.aruma.wge(df$AVG_EP, phi=best_arma_estimates$phi, theta = best_arma_estimates$theta, d = 1, s=0, n.ahead=36, lastn=TRUE)
prediction_ase_ricco = mean((df$AVG_EP[(266-35):266]-f$f)^2) 
print(paste("Last 36 ASE was s:", prediction_ase_ricco, "for p:", best_p_narrow_ricco, "q:" , best_q_narrow_ricco, "and d = 1"))
