...
min_q_narrow_ricco = which.max(c(1, best_q_wide_ricco-2))
min_p_narrow_ricco = which.max(c(1, best_p_wide_ricco-4))
q_seq_narrow_ricco = seq(min_q_narrow_ricco, best_q_wide_ricco+2, 1)
p_seq_narrow_ricco = seq(min_p_narrow_ricco, best_q_wide_ricco+4, 1)
